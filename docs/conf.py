# -*- coding: utf-8 -*-
#
# repoze.zodbconn documentation build configuration file
#
...
latex_documents = [
  ('index', 'repoze.zodbconn.tex', 'repoze.zodbconn Documentation',
